    ...
    var doc = document, win = window,
        ColorPicker = function (x, y, size, initcolor, element) {
            ...
            var w3 = 3 * size / 200,
                ...
                wh = s * 2 / 3 - padding * 2;
	    // r.setViewBox(0, 0, size, height, true);
...
var translateMouse = function(element, x, y) {
  var bRect = element.getBBox();
  var mouseX = (x - bRect.x)*(element.width/bRect.width);
  var mouseY = (y - bRect.y)*(element.height/bRect.height);
