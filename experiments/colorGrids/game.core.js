...
var game_core = function(options){
  ...
  this.projectName = 'colorGrids';
  this.experimentName = 'colorGrids';
  ...
  this.world = { width : WORLD_WIDTH, height : WORLD_HEIGHT, gridDimension : GRID_DIMENSION, numObjs : NUM_OBJS };
...
game_core.prototype.makeTrialList = function () {
  ...
  for (var i = 0; i < this.numRounds; i++) {
    ...
    if (i < this.numRounds/3.0)
      condition = trial.CONDITION_FAR;
    else if (i < 2.0*this.numRounds/3.0)
