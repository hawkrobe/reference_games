...
```{r}
d <- read_csv('/Users/judithfan/reference_games/data/3dObjects/sketchpad_repeated/group_data.csv') 
...
d.toplot <- d %>%
  ...
  summarize(len = mean(numStrokes), se=sd(numStrokes)/sqrt(length(numStrokes)))
