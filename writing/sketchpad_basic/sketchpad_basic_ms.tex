...
Features were extracted using VGG-19 \cite{simonyan2014very}, a high-performing deep convolutional neural network model class that had been pre-trained to categorize objects on the Imagenet database, which contains millions of photographs from hundreds of object categories \cite{deng2009imagenet}.


Prior work has shown a strong isomorphism between the representations of object categories in drawings and photos at higher layers in these models \cite[]{fan2015common}.
...
the \textit{Sketchy} database contains tens of thousands of sketches that people produced based on natural photos \cite[]{sangkloy2016sketchy}
