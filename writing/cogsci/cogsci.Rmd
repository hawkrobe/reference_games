...
The other definitional property we consider is *stability*: it must be in everyone's best interest to keep using the convention, once established. 
...
```{r arbitrarinessFig, cache = T, fig.env = "figure", fig.pos = "t", fig.align='center', fig.width=3, fig.height=1.5, num.cols.cap=1, fig.cap = "\\label{fig:modelConvergence} Players are initially ambivalent between the two labels (arbitrariness). Once a particular mapping is established on the first round, that mapping is likely to persist (stability)."}
